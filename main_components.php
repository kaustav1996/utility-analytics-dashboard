...
<head>
    ...
    <title>Utility Analytics Dashboard</title>
    <!-- Favicon icon -->
    ...
    <link rel="stylesheet" href="./plugins/tables/css/datatable/buttons.bootstrap4.min.css">
    <link rel="stylesheet" href="./plugins/tables/css/datatable/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" href="./plugins/tables/css/datatable/select.dataTables.min.css">
                    ...
                    <ul class="metismenu" id="menu">
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false">
                                ...
                                <li><a href="./tms.php">TMS Dashboard</a></li>
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false">
                                    <li><a href="./tabular_reports.php">Tabular Reports</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
